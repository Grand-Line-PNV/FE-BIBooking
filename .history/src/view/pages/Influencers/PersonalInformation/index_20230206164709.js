                ...
                <div className={cx("block-container")}>
                  ...
                  <div className={cx("verifyAccount")}>
                    ...
                    <div className={cx("termsOfService")}>
                        <strong className={cx("text-1")}>Please review, mark agree and proceed to finish</strong>
                        <p className={cx("text-2")}>Please read our <strong>Terms of Service</strong> carefully</p>
                        <span><input type="checkbox" className={cx("input-checkbox")}/> I agree with  Terms of Service</span>
                    </div>
