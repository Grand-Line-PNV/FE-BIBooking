...
const ShowCampaign = ({ data }) => {
  ...
  const handleFilter = (selectedValue) => {
    ...
    const filtered = selectedValue === "" ? data : data.filter(item => item.socialChannel === selectedValue);
  ...
  return (
    ...
    <select value={selectedValue} onChange={(e) => handleFilter(e.target.value)}>
            ...
            <div className={cx("card-content")}>
              ...
              <ul className={cx("card-list")}>
                ...
                <li className={cx("card-list-item")}>
                  ...
                  <span className={cx("card-item-text")}>{item.started_date}</span>
                </li>
              </ul>
              <div className={cx("card-campaign-wrapper")}>
                <div className={cx("card-social")}>
                  <ul className={cx("list-icons")}>
                    ...
                    <li>
                      <a href="#">
                        <FontAwesomeIcon className={cx("fa")} icon={faTiktok} />
                      </a>{" "}
                    </li>
                  </ul>
                  <p className={cx("card-campaign")}>{item.campaign_status}</p>
                </div>
