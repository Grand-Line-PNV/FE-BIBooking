      ...
      <div className={cx("container")}>
        <div className={cx("infor-container")}>
          <div className={cx("content")}>
            <h2 className={cx("infor-heading")}>I am creative web developer</h2>
            <div className={cx("infor-desc")}>
              <p>
                Your future client wants to know about you before they hire. Put
                some more <br />
                information about yourself. For example, I provide
                cost-effective <br />
                and high quality products to meet my Clients’ needs and so on.
              </p>
            </div>
