        ...
        <div className={cx("background-login")}>
          ...
          <div className={cx("rectangle2")}>
            <div className={cx("rectangle2-form")}>
              ...
              <div className={cx("brand-login")} style={{display:showBrandLogin ? 'none':'block',transition: '0.5s'}}>
                <h4 style={{ color: "gray", marginLeft: "37%",marginTop:'5px'}}>___ OR ___</h4>
