                  ...
                  {imagesCampaign.map((imageUrl, index) => (
                    <>
                      <img
                        ...
                        name="productImages"
                      />
                      <Button className={cx("btn-delete")} primary={true} onClick={() => handleRemoveImageCampaign(index)}>
                        Remove
                      </Button>
                    </>
                  ))}
                  ...
                  {imagesProduct.map((imageUrl, index) => (
                    <>
                      <img
                        ...
                        name="productImages"
                      />
                      <Button className={cx("btn-delete")} primary={true} onClick={() => handleRemoveImageProduct(index)}>
                        Remove
                      </Button>
                    </>
                  ))}
