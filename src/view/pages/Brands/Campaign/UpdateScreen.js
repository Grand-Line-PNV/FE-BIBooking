...
export default function UpdateCampaign({
  ...
  const handleImageChangeCampaign = (e) => {
    ...
    setUpdatedData({ ...updatedData, "campaignImages[]": files });
  ...
  const handleImageChangeProduct = (e) => {
    const files = e.target.files;
    setUpdatedData({ ...updatedData, "productImages[]": files });
  ...
  const handleChangeChannel = (event) => {
    ...
    if (isChecked) {
      ...
      setUpdatedData((prevData) => {
        if (Array.isArray(prevData.socialChannel)) {
          // check if prevData.socialChannel is an array
          return {
            ...prevData,
  ...
  return (
    <section className={cx("form-update", "animation")}>
      <div className={cx("container")}>
        <div className={cx("form-container")}>
          <p className={cx("profile-path", "heading-small", "profile-top")}>
            <span>Home</span>
            <span> Update Campaign</span>
          </p>
          <h2 className={cx("profile-title", "heading")}>Update Campaign</h2>
                ...
                <div className={cx("form")}>
                  ...
                  <div className={cx("form-group")}>
                    <Input
                      ...
                      title="Hashtag"
                      name="hashtag"
                      value={data.hashtag || updatedData.hashtag}
                      onChange={handleInputChange}
                      require
                      star
                    />
                  ...
                  <div className={cx("form-group", "phone-group")}>
                    <Input
                      ...
                      title="Quantity"
                      name="amount"
                      value={data.amount || updatedData.amount}
                      onChange={handleInputChange}
                      min="0"
                      max="999"
                      require
                  ...
                  <div className={cx("textarea-group")}>
                    ...
                    <textarea
                      ...
                      id={cx("description")}
                      name="description"
                      value={data.description || updatedData.description}
                      onChange={handleInputChange}
                      require
                    />
                    {errors.description && (
                  ...
                  <div className={cx("form-group")}>
                    <Input
                      ...
                      title="Industry"
                      name="industry"
                      value={data.industry || updatedData.industry}
                      onChange={handleInputChange}
                      require
                      star
                    />
                  ...
                  <div className={cx("form-group")}>
                    <Input
                      ...
                      title="Interest"
                      name="interest"
                      value={data.interest || updatedData.interest}
                      onChange={handleInputChange}
                      require
                      star
                    />
                  ...
                  <div className={cx("textarea-group")}>
                    ...
                    <textarea
                      ...
                      id={cx("require")}
                      name="require"
                      value={data.require || updatedData.require}
                      onChange={handleInputChange}
                      require
                    />
                    {errors.require && (
                  ...
                  <div className={cx("form-group")}>
                    <Input
                      ...
                      title="Start Date"
                      name="started_date"
                      value={data.started_date || updatedData.started_date}
                  ...
                  <div className={cx("form-group")}>
                    <Input
                      ...
                      title="End Date"
                      name="ended_date"
                      value={data.ended_date || updatedData.ended_date}
                  ...
                  <div className={cx("form-group")}>
                    <Input
                      ...
                      title="Price"
                      name="price"
                      value={data.price || updatedData.price}
                      onChange={handleInputChange}
                      min="0"
                      max="100000000"
                      require
